...
#ifndef TACO2_UTIL_ITERATORS_HPP
#define TACO2_UTIL_ITERATORS_HPP


#include <cstddef>
#include <iterator>

namespace taco2::util::iterators {
    /**************************************
    ...
    public:
        ...
        inline friend bool operator!=(const derived_type& lhs, const derived_type& rhs) { return !(lhs == rhs); }
    };
    ...
    public:
        ...
        inline reference operator[](difference_type n) const { return *(*static_cast<const derived_type*>(this) + n); }
        ...
        inline friend bool operator<=(const derived_type& lhs, const derived_type& rhs) { return !(rhs < lhs); }
    ...
    public:
        ...
        inline reference operator[](size_type n) const { return *(*static_cast<const derived_type*>(this) + n); }
    ...
    public:
        ...
        inline key_iterator(subiterator it) noexcept : m_it(it) {}
        ...
        inline bool operator==(const self_type& rhs) const { return m_it == rhs.m_it; }
    ...
    template<class M>
    class value_iterator : bidirectional_iterator_base3<value_iterator<M>, detail::value_iterator_types<M>>
    {
    public:
        ...
        inline value_iterator(subiterator it) noexcept : m_it(it) {}
    ...
    template<class It>
    class stepping_iterator : public random_access_iterator_base3<stepping_iterator<It>, std::iterator_traits<It>>
    {
    public:
        ...
        inline stepping_iterator(subiterator it, difference_type step) noexcept : m_it(it), m_step(step) {}
        ...
        inline difference_type operator-(const self_type& rhs) const { return std::distance(rhs.m_it, m_it) / m_step; }

        inline reference operator*() const { return *m_it; }

        inline pointer operator->() const { return m_it; }

        inline bool equal(const self_type& rhs) const { return m_it == rhs.m_it && m_step == rhs.m_step; }

        inline bool less_than(const self_type& rhs) const { return m_it < rhs.m_it && m_step == rhs.m_step; }
    ...
    template<class It>
    inline stepping_iterator<It> make_stepping_iterator(It it, typename std::iterator_traits<It>::difference_type step)
    {
